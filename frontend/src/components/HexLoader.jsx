...
export default function HexLoader({ size = 200 }) {
  const scale = size / 200
  return (
    <div className="hex-socket" style={{ width: size, height: size }}>
      <div style={{ transform: `scale(${scale})`, width: 200, height: 200, position: 'relative' }}>
